...
double deg_rad(double x) { return x * pi() / 180; }

// Radians to degree conversion
double rad_deg(double x) { return x * 180 / pi(); }
...
int NearestWaypt(double x, double y, const vector<double> &maps_x,
...
// Find next waypoint
int NextWaypt(double x, double y, double theta, const vector<double> &maps_x,
              const vector<double> &maps_y) {
...
vector<double> Frenet(double x, double y, double theta,
...
vector<double> Cartesian(double s, double d, const vector<double> &maps_s,
                         const vector<double> &maps_x,
                         const vector<double> &maps_y) {
  int prev_wp = -1;
